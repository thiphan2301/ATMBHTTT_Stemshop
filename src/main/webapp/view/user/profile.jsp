...
<div class="profile-container">
    ...
    <div class="profile-body">
        <form id="profile-form" class="profile-form" method="post" action="${pageContext.request.contextPath}/profile"
            ...
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <div class="gender-options">
                        ...
                        <input type="radio" id="gender-female" name="gender"
                               value="NU" ${user.gender == 'NU' ? 'checked' : ''}>
                        <label for="gender-female">Nữ</label>

                        <input type="radio" id="gender-other" name="gender"
                               value="KHAC" ${user.gender == 'KHAC' ? 'checked' : ''}>
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" id="street" class="form-control" style="margin-top: 15px;"
            ...
            <div style="margin-top: 30px; display: flex; gap: 15px; align-items: center;">
                <button type="submit" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Lưu Thay Đổi
                </button>
                <button type="button" class="btn btn-outline" onclick="togglePasswordBox()"><i
                        class="fa-solid fa-key"></i> Đổi Mật Khẩu
                </button>
                <button type="button" class="btn btn-outline" onclick="togglePublicKeyBox()"><i
                        class="fa-solid fa-shield-halved"></i> Cấu Hình Khóa Số
                </button>
            </div>
        </form>
                ...
                <c:choose>
                    ...
                    <c:when test="${empty user.avatar}">
                        <img id="avatarPreview"
                             src="${pageContext.request.contextPath}/assets/images/user/user-male-circle.jpg"
                    ...
                    <c:otherwise>
                        <img id="avatarPreview" src="${pageContext.request.contextPath}/avatar/${user.avatar}"
                             class="avatar-img" alt="Avatar">
                    </c:otherwise>
                </c:choose>
    ...
    <input type="file" id="avatarInput" form="profile-form" name="avatar" accept="image/png, image/jpeg"
           style="display: none;">
            ...
            <div class="form-group full-width">
                ...
                <c:choose>
                    ...
                    <c:when test="${not empty publicKey}">
                        <span style="color: #2e7d32; font-weight: bold; font-size: 15px;"><i
                                class="fa-solid fa-circle-check"></i> Đã cấu hình</span>
                        <div style="margin-top: 15px; padding: 15px; background: #e8f5e9; border-radius: 6px; border: 1px solid #c8e6c9;">
                            <p style="margin: 0 0 10px 0; font-size: 14px; color: #1b5e20;">
                                <strong>Khóa hiện tại của bạn đang hoạt động.</strong> Để bảo mật, bạn không thể thêm
                                khóa mới đè lên khóa cũ.
                            </p>
                    ...
                    <c:otherwise>
                        <span style="color: #c62828; font-weight: bold; font-size: 15px;"><i
                                class="fa-solid fa-circle-xmark"></i> Chưa có khóa (Vui lòng cập nhật để ký đơn hàng)</span>

                        <%-- Form upload hỗ trợ cả file và text --%>
                        <form action="${pageContext.request.contextPath}/update-public-key" method="post"
                            ...
                            <div class="form-group full-width">
                                ...
                                <small style="color: #757575;">Hệ thống sẽ ưu tiên đọc nội dung file nếu bạn tải
                                    lên.</small>
                            </div>
                            ...
                            <div style="margin-top: 20px;">
                                <button type="submit" class="btn btn-primary"><i class="fa-solid fa-cloud-arrow-up"></i>
                                    Cập Nhật Khóa Số
                                </button>
                            </div>
                        </form>
